...
typedef enum {
  TK_NONE, TK_IDENT, TK_NUMBER, TK_CHAR, TK_EOF, TK_CONSTSTRING,           //không có dạng, dạng xâu, dạng chữ, hằng xâu, kí tự kết thúc

  KW_PROGRAM, KW_CONST, KW_TYPE, KW_VAR,                    // các từ khóa 
