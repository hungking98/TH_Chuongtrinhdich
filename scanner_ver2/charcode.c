...
CharCode charCodes[256] = {
  ...
  CHAR_SPACE, CHAR_EXCLAIMATION, CHAR_NHAYKEP, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_UNKNOWN, CHAR_SINGLEQUOTE,
  ...
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_LETTER,
  CHAR_LETTER, CHAR_LETTER, CHAR_LETTER, CHAR_VUONGTRAI, CHAR_UNKNOWN, CHAR_VUONGPHAI, CHAR_UNKNOWN, CHAR_LETTER,     // kí tự 
